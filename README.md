...
** meant to be used as the complete version of 'docker_events_universal.sh' from All-in-one ... so if you change miner versions in .conf the service will install that version... if you dont use %CPU_THREADS% in your .conf then auto cpu threads/affinity will not get added to the final cmd

# -- rig conf examples... --

# -- %WORKER_NAME%           rig hostname in ARGS, WALLET, PASS, POOL                        --
# -- %WARTHOG_TARGET%        WARTHOG_TARGET in ARGS                                          --
# -- %CPU_THREADS%           cpu total threads -1 and affinity in ARGS see 'cpu threads.txt' --
# -- SCREEN_NAME 0 "miner"   different screen name than miner name                           --
# -- CUSTOM_MINER 0 "path"   custom binary file                                              --

#========================================================================================================
** keep as none sudo tee so they can be overwritten using putty/ssh **
