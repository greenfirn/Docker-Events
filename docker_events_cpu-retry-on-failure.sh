...
ARGS="-a rx/0 --randomx-1gb-pages --huge-pages -o pool.supportxmr.com:9000 -u wallet-address -p 5950X-2-3070 -t 31 --cpu-affinity=0xFFFFFFFD --tls -k --http-host=127.0.0.1 --http-port=18080"
